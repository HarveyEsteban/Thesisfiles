  ...
  <div class="container-fluid">
                <h3 class="text-dark mb-0" style="font-weight: bold;">List of Patients</h3>
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="mb-3">
                                <form method="GET" action="Listofpatients.php">

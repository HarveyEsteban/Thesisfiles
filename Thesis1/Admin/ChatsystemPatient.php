...
function update_last_activity()
 ...
 function make_chat_dialog_box(to_user_id, to_user_name)
 {
  ...
  modal_content += '<div style="height:400px; border:1px solid #e8e3cb; overflow-y: scroll; margin-bottom:24px; padding:16px;" class="chat_history" data-touserid="'+to_user_id+'" id="chat_history_'+to_user_id+'">';
  modal_content += '</div>';
